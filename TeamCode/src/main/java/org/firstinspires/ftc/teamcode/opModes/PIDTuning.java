...
//					new DriveToPose(d, o, t, new Pose2d(0, 0, Rotation2d.fromDegrees(90)), 3.0),
//					new Wait(1.0),
//					new DriveToPose(d, o, t, new Pose2d(10, 0, Rotation2d.fromDegrees(90)))
//				)
		new HoldPose(d, o, t, new Pose2d(0, 0, Rotation2d.fromDegrees(90)))
		);
